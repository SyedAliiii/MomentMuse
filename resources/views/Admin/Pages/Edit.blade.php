						...
						<div class="col-lg-10 col-10 m-1 py-2 border" data-aos="fade-up">
							<div class="d-md-flex d-block blog-entry align-items-start">
								<div class="mr-md-5 img-wrap">
									<form action="{{ route('admin.blogUpdate', $data->id) }}" method="post" enctype="multipart/form-data">
										@csrf
										{{-- @method('POST') --}}
									<img src="{{ asset('images/blogs/' . old('image', $data->image)) }}" alt="Image" class="img-fluid mb-0 rounded" width="200px" height="200px">
								...
								<div class="w-100">
									<div class="testiContent">
											...
											<textarea class="form-control mb-1" rows="2" placeholder="Enter Blog" id="blog" name="blog">{{ old('blog', $data->blog) }}</textarea>
